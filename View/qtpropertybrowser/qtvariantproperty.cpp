...
/*!
    ...
    \sa propertyType(), valueType()
*/
int QtVariantPropertyManager::flagTypeId() { return qMetaTypeId<QtFlagPropertyType>(); }
...
/*!
    ...
    \sa propertyType(), valueType()
*/
int QtVariantPropertyManager::groupTypeId() { return qMetaTypeId<QtGroupPropertyType>(); }
...
*/
int QtVariantPropertyManager::iconMapTypeId() { return qMetaTypeId<QtIconMap>(); }

typedef QMap<const QtProperty*, QtProperty*> PropertyMap;
Q_GLOBAL_STATIC(PropertyMap, propertyToWrappedProperty)

static QtProperty* wrappedProperty(QtProperty* property) { return propertyToWrappedProperty()->value(property, 0); }
...
*/
QVariant QtVariantProperty::value() const { return d_ptr->manager->value(this); }
...
/*!
    ...
    \sa propertyType()
*/
int QtVariantProperty::valueType() const { return d_ptr->manager->valueType(this); }
...
/*!
    ...
    \sa valueType()
*/
int QtVariantProperty::propertyType() const { return d_ptr->manager->propertyType(this); }
...
/*!
    ...
    \sa value()
*/
void QtVariantProperty::setValue(const QVariant& value) { d_ptr->manager->setValue(this, value); }
    ...
    , d_ptr(new QtVariantPropertyManagerPrivate)
{
    ...
    connect(intPropertyManager,
            SIGNAL(rangeChanged(QtProperty*, int, int)),
            this,
            SLOT(slotRangeChanged(QtProperty*, int, int)));
    connect(intPropertyManager,
            SIGNAL(singleStepChanged(QtProperty*, int)),
            this,
    ...
    connect(doublePropertyManager,
            ...
            this,
            SLOT(slotValueChanged(QtProperty*, double)));
    connect(doublePropertyManager,
            SIGNAL(rangeChanged(QtProperty*, double, double)),
            this,
            SLOT(slotRangeChanged(QtProperty*, double, double)));
    connect(doublePropertyManager,
            SIGNAL(singleStepChanged(QtProperty*, double)),
            this,
            SLOT(slotSingleStepChanged(QtProperty*, double)));
    connect(doublePropertyManager,
            SIGNAL(decimalsChanged(QtProperty*, int)),
            this,
    ...
    connect(boolPropertyManager,
            ...
            this,
            SLOT(slotValueChanged(QtProperty*, bool)));
    ...
    connect(stringPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QString)),
            this,
            SLOT(slotValueChanged(QtProperty*, QString)));
    connect(stringPropertyManager,
    ...
    connect(datePropertyManager,
            SIGNAL(valueChanged(QtProperty*, QDate)),
            this,
            SLOT(slotValueChanged(QtProperty*, QDate)));
    connect(datePropertyManager,
            SIGNAL(rangeChanged(QtProperty*, QDate, QDate)),
            this,
    ...
    connect(timePropertyManager,
            SIGNAL(valueChanged(QtProperty*, QTime)),
            this,
            SLOT(slotValueChanged(QtProperty*, QTime)));
    ...
    connect(dateTimePropertyManager,
            SIGNAL(valueChanged(QtProperty*, QDateTime)),
            this,
            SLOT(slotValueChanged(QtProperty*, QDateTime)));
    ...
    connect(keySequencePropertyManager,
            SIGNAL(valueChanged(QtProperty*, QKeySequence)),
            this,
            SLOT(slotValueChanged(QtProperty*, QKeySequence)));
    // CharPropertyManager
    ...
    connect(charPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QChar)),
            this,
            SLOT(slotValueChanged(QtProperty*, QChar)));
    ...
    connect(localePropertyManager,
            SIGNAL(valueChanged(QtProperty*, QLocale)),
            this,
            SLOT(slotValueChanged(QtProperty*, QLocale)));
    ...
    connect(pointPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QPoint)),
            this,
            SLOT(slotValueChanged(QtProperty*, QPoint)));
    ...
    connect(pointFPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QPointF)),
            this,
            SLOT(slotValueChanged(QtProperty*, QPointF)));
    connect(pointFPropertyManager,
            SIGNAL(decimalsChanged(QtProperty*, int)),
            this,
            SLOT(slotDecimalsChanged(QtProperty*, int)));
    ...
    connect(sizePropertyManager,
            SIGNAL(valueChanged(QtProperty*, QSize)),
            this,
            SLOT(slotValueChanged(QtProperty*, QSize)));
    connect(sizePropertyManager,
            SIGNAL(rangeChanged(QtProperty*, QSize, QSize)),
            this,
            SLOT(slotRangeChanged(QtProperty*, QSize, QSize)));
    ...
    connect(sizeFPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QSizeF)),
            this,
            SLOT(slotValueChanged(QtProperty*, QSizeF)));
    connect(sizeFPropertyManager,
            SIGNAL(rangeChanged(QtProperty*, QSizeF, QSizeF)),
            this,
            SLOT(slotRangeChanged(QtProperty*, QSizeF, QSizeF)));
    connect(sizeFPropertyManager,
            SIGNAL(decimalsChanged(QtProperty*, int)),
            this,
            SLOT(slotDecimalsChanged(QtProperty*, int)));
    ...
    connect(rectPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QRect)),
            this,
            SLOT(slotValueChanged(QtProperty*, QRect)));
    connect(rectPropertyManager,
            SIGNAL(constraintChanged(QtProperty*, QRect)),
            this,
            SLOT(slotConstraintChanged(QtProperty*, QRect)));
    ...
    connect(rectFPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QRectF)),
            this,
            SLOT(slotValueChanged(QtProperty*, QRectF)));
    connect(rectFPropertyManager,
            SIGNAL(constraintChanged(QtProperty*, QRectF)),
            this,
            SLOT(slotConstraintChanged(QtProperty*, QRectF)));
    connect(rectFPropertyManager,
            SIGNAL(decimalsChanged(QtProperty*, int)),
            this,
            SLOT(slotDecimalsChanged(QtProperty*, int)));
    ...
    connect(colorPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QColor)),
            this,
            SLOT(slotValueChanged(QtProperty*, QColor)));
    ...
    connect(enumPropertyManager,
            SIGNAL(enumIconsChanged(QtProperty*, QMap<int, QIcon>)),
            this,
            SLOT(slotEnumIconsChanged(QtProperty*, QMap<int, QIcon>)));
    ...
    connect(sizePolicyPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QSizePolicy)),
            this,
            SLOT(slotValueChanged(QtProperty*, QSizePolicy)));
    ...
    connect(fontPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QFont)),
            this,
            SLOT(slotValueChanged(QtProperty*, QFont)));
    ...
    connect(cursorPropertyManager,
            SIGNAL(valueChanged(QtProperty*, QCursor)),
            this,
            SLOT(slotValueChanged(QtProperty*, QCursor)));
    // FlagPropertyManager
    ...
    connect(flagPropertyManager,
            ...
            SLOT(slotValueChanged(QtProperty*, int)));
    connect(flagPropertyManager,
            SIGNAL(flagNamesChanged(QtProperty*, QStringList)),
            this,
            SLOT(slotFlagNamesChanged(QtProperty*, QStringList)));
...
*/
QtVariantPropertyManager::~QtVariantPropertyManager() { clear(); }
...
{
    const QMap<const QtProperty*, QPair<QtVariantProperty*, int>>::const_iterator it = d_ptr->m_propertyToType
                                                                                           .constFind(property);
...
void QtVariantPropertyManager::initializeProperty(QtProperty* property)
{
    ...
    QMap<int, QtAbstractPropertyManager*>::ConstIterator it = d_ptr->m_typeToPropertyManager.find(
        d_ptr->m_propertyType);
...
{
    const QMap<const QtProperty*, QPair<QtVariantProperty*, int>>::iterator type_it = d_ptr->m_propertyToType.find(
        property);
...
void QtVariantEditorFactory::connectPropertyManager(QtVariantPropertyManager* manager)
{
    ...
    const QList<QtDateTimePropertyManager*> dateTimePropertyManagers = manager
    ...
    const QList<QtKeySequencePropertyManager*>
    ...
    const QList<QtSizePolicyPropertyManager*>
