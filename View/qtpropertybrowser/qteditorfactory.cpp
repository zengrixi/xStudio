...
void QtLineEditFactory::connectPropertyManager(QtStringPropertyManager* manager)
{
    ...
    connect(manager, SIGNAL(regExpChanged(QtProperty*, QRegExp)), this, SLOT(slotRegExpChanged(QtProperty*, QRegExp)));
}
...
{
    disconnect(manager, SIGNAL(valueChanged(QtProperty*, QDate)), this, SLOT(slotPropertyChanged(QtProperty*, QDate)));
    disconnect(manager,
               SIGNAL(rangeChanged(QtProperty*, QDate, QDate)),
               this,
               SLOT(slotRangeChanged(QtProperty*, QDate, QDate)));
...
{
    disconnect(manager, SIGNAL(valueChanged(QtProperty*, QTime)), this, SLOT(slotPropertyChanged(QtProperty*, QTime)));
}
...
{
    disconnect(manager, SIGNAL(valueChanged(QtProperty*, QChar)), this, SLOT(slotPropertyChanged(QtProperty*, QChar)));
}
...
{
    connect(manager, SIGNAL(valueChanged(QtProperty*, QCursor)), this, SLOT(slotPropertyChanged(QtProperty*, QCursor)));
}
